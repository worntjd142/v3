	...
	<table class="table table-striped table-secondary table-hover table-bordered table-responsive">
		<thead>			
			...
			<tr>
				...
				<td><input type="number" name="ricount"></td>
	...
	<form action="order" method="get">
		<table class="table table-striped table-hover table-bordered table-responsive">
			<thead>
				...
				<tr>
					<th scope="col">수주일</th>
					<td><input type="date" name="startday" id="startday" value="${paging.cdto.startday}"> 
						<label> ~ </label>		 
						<input type="date" name="endday" value="${paging.cdto.endday}"></td>
				</tr>
			</thead>
			<tbody>
				<tr>
				...
				<tr>
					<td><input type="submit" value="조회" onclick="search()" class="btn btn-outline-secondary btn-sm"></td>
				</tr>
			</tbody>
		</table>
	</form>
