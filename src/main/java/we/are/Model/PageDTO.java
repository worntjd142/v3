...
public class PageDTO {
	...
	public PageDTO (CriteriaDTO cdto, int total) {
		this.cdto = cdto;
		this.total = total;
		...
		this.endPage = (int)(Math.ceil(cdto.getPageNum() / 10.0)) * 10;
		...
		int realnd = (int)(Math.ceil((total * 1.0) / cdto.getAmount()));
	...
	public CriteriaDTO getCdto() {
		return cdto;
	}

	public void setCdto(CriteriaDTO cdto) {
		this.cdto = cdto;
	}
